...
class skill:
    ...
    def use_skill(self, user, opponent, is_player):
...
# uses the skill
def use_skill(user, opponent, skill_name, is_player):
    skill_class_dict[skill_name].use_skill(user, opponent, is_player)
